...
public class ConfigTest implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Postagem po1 = new Postagem(null, Instant.parse("2018-01-24T14:12:47Z"),
				"Call of Duty: Modern Warfare é massa!",
				"O jogo Call of Duty: Modern Warfare é muito massa, vale a grana", ed2);
		Postagem po2 = new Postagem(null, Instant.parse("2019-08-24T21:34:23Z"), "O novo processador Intel Core i15",
				"A nova tecnologia desse processador é de outro mundo", ed1);
		Postagem po3 = new Postagem(null, Instant.parse("2020-12-12T09:12:47Z"), "A próxima safra de soja será recorde",
				"Dados indicam que o Brasil vai dobrar a produção registrada no ano anterior", ed3);

		postagemRepository.saveAll(Arrays.asList(po1, po2, po3));

		Comentario cm1 = new Comentario(null, "Fantástico", Instant.parse("2018-01-24T15:12:47Z"),
				"Esse jogo é muito massa mesmo!");
		Comentario cm2 = new Comentario(null, "Muito rápido!", Instant.parse("2019-08-24T21:37:23Z"),
				"Eu tenho ele aqui e a velocidade é de outro mundo");
		Comentario cm3 = new Comentario(null, "Depende", Instant.parse("2020-12-21T04:19:47Z"),
				"Isso se continuar chovendo...");
